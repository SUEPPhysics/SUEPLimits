...
## Additional Files
submission.add_additional_resource("ZH Signal Fragment", "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/ZHleptonic_template.py", copy_file=True)
...
decay_modes = {
    "Hadronic": {
        "observed": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/hadronic_UL_SRCR.txt",
        "expected": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/hadronic_UL_SRCR_Exp.txt",
        "image": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/BR_XSec_1D.pdf",
    ...
    "Leptonic": {
        "observed": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/leptonic_UL_SRCR.txt",
        "expected": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/leptonic_UL_SRCR_Exp.txt",
        "image": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/BR_XSec_1D.pdf",
    ...
    "Generic": {
        "observed": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/generic_UL_SRCR.txt",
        "expected": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/generic_UL_SRCR_Exp.txt",
        "image": "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/BR_XSec_1D.pdf",
...
def ConsolidateAgnosticLimits(title, description, location, input_file, image=None):
    ...
    oneSigma = hlib.Uncertainty(r"$1\sigma$", is_symmetric=False)
    oneSigma.values = list(zip(minus1sig, plus1sig))
    ...
    twoSigma = hlib.Uncertainty(r"$2\sigma$", is_symmetric=False)
    twoSigma.values = list(zip(minus2sig, plus2sig))
...
ConsolidateAgnosticLimits(
    ...
    input_file="/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/AgnosticLimits.txt",
    image="/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/scan_agnostic.pdf"
)
...
postFit("SR B-Only Post-Fit",
       ...
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/SR_Postfit_forPaper.pdf",
       False,
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/output_4_8.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/output_CRfit_4_8.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/SR_2_2_prefit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/SR_6_3_prefit.root")
...
postFit("PR B-Only Post-Fit",
       ...
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/PR_Postfit_forPaper.pdf",
       False,
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/PRCRfit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/PRCR_fitCR_CR.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/SR_2_2_prefit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/SR_6_3_prefit.root")
...
postFit("CRDY B-Only Post-Fit",
       ...
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/CRDY_Postfit_forPaper.pdf",
       True,
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/output_CRDY_4_8.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/output_CRDY_4_8_CRfit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/CRDY_2_2_prefit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/CRDY_6_3_prefit.root")
...
postFit("CRTT B-Only Post-Fit",
       ...
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/CRTT_Postfit_forPaper.pdf",
       True,
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/output_CRTT_4_8.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/output_CRTT_4_8_CRfit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/CRTT_2_2_prefit.root",
       "/eos/user/g/gdecastr/SUEPCoffea_dask/HepData/Entry/CRTT_6_3_prefit.root")
