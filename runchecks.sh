...
combine -M FitDiagnostics -d ${datacard} -t -1 --expectSignal ${rVal}  --rMin -10 --forceRecreateNLL -n _t1
...
combineTool.py -M Impacts -d ${datacard} -t -1 --expectSignal ${rVal} --rMin -10 --doInitialFit --allPars -m 1 -n t1
...
combineTool.py -M Impacts -d ${datacard} -o impacts_t1.json -t -1 --expectSignal ${rVal} --rMin -10 --doFits -m 1 -n t1 --job-mode interactive --task-name t1 --sub-opts '+JobFlavour = "espresso"' 
